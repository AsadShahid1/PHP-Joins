...
<body>
    <div class="container mt-5 opacity">
        <h1 class="text-center text-dark">BRAND FORM</h1>
        <form action="" method="POST">
            <div class="row">
                <div class="col-12 my-2">
                    <div class="form-group">
                        <label for="exampleFormControlInput1"><b>Brand Name</b></label>
                        ...
                        <?php
                            ...
                            ?>  
                        id="exampleFormControlInput1" placeholder="Enter the brand name.....">
